...
public class BlockGasRadon extends BlockGasBase {
    ...
    public static final MapCodec<BlockGasRadon> CODEC = simpleCodec(BlockGasRadon::new);

    public BlockGasRadon(BlockBehaviour.Properties props) {
        super(props);
    }

    @Override
    protected MapCodec<? extends BlockGasRadon> codec() {
        return CODEC;
    }
    ...
    protected void entityInside(
        ...
        if (ArmorRegistry.hasProtection(living, EquipmentSlot.HEAD, HazardClass.PARTICLE_FINE)) {
            ...
            ContaminationUtil.contaminate(
                    living, HazardType.RADIATION, ContaminationType.RAD_BYPASS, 0.05F);
    ...
    protected AshRevealParticleOptions revealTint() {
        return new AshRevealParticleOptions(0.1F, 0.8F, 0.1F);
    }
}
