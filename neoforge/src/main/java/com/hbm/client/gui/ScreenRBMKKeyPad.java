...
public final class ScreenRBMKKeyPad extends Screen {
    ...
    private final BlockEntityRBMKKeyPad keypad;
    private final Identifier texture = Library.id("textures/gui/machine/gui_rbmk_keypad.png");
    ...
    public ScreenRBMKKeyPad(BlockEntityRBMKKeyPad keypad) {
    ...
    protected void init() {
        ...
        for (int i = 0; i < KEYS; i++) {
            BlockEntityRBMKKeyPad.KeyUnit unit = keypad.keys[i];
    ...
    public void extractRenderState(
        ...
        Component name = Component.translatable("container.rbmkKeyPad");
        graphics.text(
                font,
                name,
    ...
    private void sendSettings() {
        ...
        for (int i = 0; i < KEYS; i++) {
            ...
            data.putString("cmd" + i, cmd[i].getValue());
        }
        Services.NETWORK.sendToServer(new NbtControlPayload(keypad.getBlockPos(), data));
    }
