...
public class RenderCondenserPowered
        implements BlockEntityRenderer<BlockEntityCondenserPowered, RenderCondenserPowered.State>,
    ...
    public RenderCondenserPowered() {
        this.model = ResourceManager.condenser;
        this.bodyType = RenderTypes.entityCutout(ResourceManager.condenser_tex);
    }
    ...
    @Override
    public AABB getRenderBoundingBox(BlockEntityCondenserPowered be) {
    ...
    public void extractRenderState(
            BlockEntityCondenserPowered be,
            State state,
            float partialTicks,
            Vec3 cameraPosition,
        ...
        state.fan = Mth.lerp(partialTicks, be.prevSpin, be.spin);
    }
