...
public class RenderFusionTorusStructPreview
        implements BlockEntityRenderer<
                        BlockEntityFusionTorusStruct, RenderFusionTorusStructPreview.State>,
    ...
    @Override
    public AABB getRenderBoundingBox(BlockEntityFusionTorusStruct be) {
    ...
    public void extractRenderState(
            BlockEntityFusionTorusStruct be,
            State state,
            float partialTicks,
            Vec3 cameraPosition,
