...
public class RenderLiquefactor
        implements BlockEntityRenderer<BlockEntityMachineLiquefactor, RenderLiquefactor.State>,
                ConcurrentRenderStateExtraction {
    private static final int FLUID = ResourceManager.liquefactor.partId("Fluid");
    private static final int GLASS = ResourceManager.liquefactor.partId("Glass");
    ...
    public RenderLiquefactor() {
        this.model = ResourceManager.liquefactor;
    }
    ...
    @Override
    public AABB getRenderBoundingBox(BlockEntityMachineLiquefactor be) {
    ...
    public void extractRenderState(
            BlockEntityMachineLiquefactor be,
            State state,
            float pt,
            Vec3 cameraPosition,
