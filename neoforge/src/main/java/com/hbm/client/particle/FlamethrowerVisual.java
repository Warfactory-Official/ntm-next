...
public final class FlamethrowerVisual
        implements EffectVisual<ParticleFlamethrower>, SimpleTickableVisual {
    private final ParticleFlamethrower particle;
    private final ParticleInstance instance;
    private final Vec3i origin;

    public FlamethrowerVisual(VisualizationContext context, ParticleFlamethrower particle) {
    ...
    private void writeTick() {
        ...
        instance.size(2F * particle.getQuadSize(0F));
