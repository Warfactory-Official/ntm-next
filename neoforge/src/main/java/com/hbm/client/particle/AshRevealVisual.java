...
public final class AshRevealVisual
        implements EffectVisual<ParticleAshReveal>, SimpleTickableVisual, ShaderLightVisual {
    private final ParticleAshReveal particle;
    ...
    public AshRevealVisual(VisualizationContext context, ParticleAshReveal particle) {
        this.particle = particle;
        origin = context.renderOrigin();
        instance =
                context.instancerProvider()
                        .instancer(ParticleInstance.GROW_IN, ParticleModels.LIT)
                        .createInstance();
        writeTick();
    }
    ...
    private void writeTick() {
        ...
        instance.size(2 * particle.quadSize);
    ...
    private void publishLight() {
        ...
        double radius = particle.quadSize * 1.415 + 1;
