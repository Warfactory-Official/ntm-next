...
public final class DigammaSmokeVisual
        implements EffectVisual<ParticleDigammaSmoke>, SimpleTickableVisual {
    private final ParticleDigammaSmoke particle;
    private final ParticleInstance instance;
    private final Vec3i origin;

    public DigammaSmokeVisual(VisualizationContext context, ParticleDigammaSmoke particle) {
