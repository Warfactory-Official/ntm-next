...
public final class SplashVisual
        implements EffectVisual<ParticleSplash>, SimpleTickableVisual, ShaderLightVisual {
    private final ParticleSplash particle;
    ...
    public SplashVisual(VisualizationContext context, ParticleSplash particle) {
