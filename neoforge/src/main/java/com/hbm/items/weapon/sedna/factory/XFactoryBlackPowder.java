...
public class XFactoryBlackPowder {
    ...
    public static BulletConfig shot =
            new BulletConfig()
                    ...
                    .setProjectiles(6, 6)
                    .setDamage(1F / 6F);
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_RECOIL_PEPPERBOX =
            (stack, ctx) -> {
    ...
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_PEPPERBOX_ANIMS =
            (stack, type) -> {
                switch (type) {
                    case CYCLE:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 50)
                                                .addPos(45, 0, 0, 150, IType.SIN_DOWN)
                                                .addPos(45, 0, 0, 50)
                        ...
                        return new BusAnimation()
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                ...
                                                .addPos(90, 0, 0, 1600)
                                                .addPos(0, 0, 0, 500, IType.SIN_FULL)
                                                .addPos(-5, 0, 0, 200, IType.SIN_UP)
                                                .addPos(0, 0, 0, 200, IType.SIN_DOWN))
                                .addBus(
                                        "TRANSLATE",
                                        new BusAnimationSequence()
                                                .addPos(0, -12, 5, 500, IType.SIN_FULL)
                                                .addPos(0, -12, 5, 700)
                                                .addPos(0, -13, 5, 200)
                                                .addPos(0, -12, 5, 200)
                                                .addPos(0, -12, 5, 500)
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(0, 5, -5, 0)
                                                .addPos(0, 0, -0.1, 500, IType.SIN_FULL)
                                                .addPos(0, 0, -1, 200)
                                                .addPos(0, 0, -1, 200)
                                                .addPos(0, 0, -0.1, 200)
                                                .addPos(0, 5, -5, 500, IType.SIN_FULL)
                                                .addPos(0, 0, 0, 0))
                                .addBus(
                                        "ROTATE",
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 2600)
                                                .addPos(-360, 0, 0, 750, IType.SIN_FULL))
                                .addBus(
                                        "SHOT",
                                        new BusAnimationSequence()
                                                .addPos(1, 0, 0, 1400)
                    ...
                    case JAMMED:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(0, -6, 0, 400, IType.SIN_FULL)
                                                .addPos(0, -6, 0, 2000)
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(45, 0, 0, 400, IType.SIN_FULL)
                                                .addPos(45, 0, 0, 2000)
                                                .addPos(0, 0, 0, 400, IType.SIN_FULL));
                }
