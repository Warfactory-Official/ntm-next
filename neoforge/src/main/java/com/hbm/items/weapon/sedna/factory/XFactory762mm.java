...
public class XFactory762mm {
    ...
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_SECOND_MINIGUN =
            (stack, ctx) -> {
    ...
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_RECOIL_CARBINE =
            (stack, ctx) -> {
                ItemGunBaseNT.setupRecoil(
                        5, (float) (ctx.getPlayer().getRandom().nextGaussian() * 0.5));
            };
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_RECOIL_MINIGUN =
            (stack, ctx) -> {
                ItemGunBaseNT.setupRecoil(
    ...
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_CARBINE_ANIMS =
            (stack, type) -> {
                int ammo =
                    ...
                    case CYCLE:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0.25, 50)
                                                .addPos(0, 0.125, 1.25, 100, IType.SIN_UP));
                    case CYCLE_DRY:
                        return new BusAnimation()
                                .addBus(
                                        "SLIDE",
                        ...
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                ...
                                                .addPos(0, 0, -1, 100, IType.SIN_DOWN)
                                                .addPos(0, 0, -1, 50)
                                                .addPos(0, 0, -0.25, 100, IType.SIN_UP)
                                                .addPos(0, 0, -0.25, 1250)
                                                .addPos(0, 0, -1, 100, IType.SIN_DOWN)
                                                .addPos(0, 0, -1, 50)
                                                .addPos(0, 0, 0, 100, IType.SIN_UP))
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 250)
                                                .addPos(0, 0, 0.25, 150)
                                                .addPos(0, 0.125, 1, 100, IType.SIN_UP)
                                                .addPos(0, 0.125, 1, 1250)
                                                .addPos(0, 0.125, 0.25, 100, IType.SIN_DOWN)
                                                .addPos(0, 0.125, 1, 100, IType.SIN_UP));
                    case INSPECT:
                        return new BusAnimation()
                                .addBus(
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(0, 0, -0.75, 150, IType.SIN_DOWN)
                                                .addPos(0, 0, -0.75, 1000)
                                                .addPos(0, 0, 0, 100, IType.SIN_UP))
                                .addBus(
                                        ammo == 0 ? "NULL" : "REL",
                                        new BusAnimationSequence()
                                                .addPos(0, 0.125, 1.25, 0)
                                                .addPos(0, 0.125, 1.25, 500)
                                                .addPos(0, 0.125, 0.5, 150, IType.SIN_DOWN)
                                                .addPos(0, 0.125, 0.5, 1000)
                                                .addPos(0, 0.125, 1.25, 100, IType.SIN_UP));
                }
    ...
    @SuppressWarnings("incomplete-switch")
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_MINIGUN_ANIMS =
            (stack, type) -> {
                switch (type) {
                    case EQUIP:
                        return new BusAnimation()
                    ...
                    case CYCLE:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 60, 50)
                                                .addPos(0, 0, 720, 1000, IType.SIN_DOWN));
                    case CYCLE_DRY:
                        return new BusAnimation()
                                .addBus(
                                        "ROTATE",
                    ...
                    case RELOAD:
                        return new BusAnimation()
                                .addBus(
                                        "EQUIP",
                                        new BusAnimationSequence()
                                                .addPos(-15, 0, 0, 250, IType.SIN_DOWN)
                                                .addPos(0, 0, 0, 500, IType.SIN_FULL))
                                .addBus(
                                        "ROTATE",
                                        new BusAnimationSequence()
                    ...
                    case INSPECT:
                        return new BusAnimation()
                                .addBus(
                                        "EQUIP",
                                        new BusAnimationSequence()
                                                .addPos(3, 0, 0, 150, IType.SIN_DOWN)
                                                .addPos(0, 0, 0, 100, IType.SIN_FULL))
                                .addBus(
                                        "ROTATE",
                                        new BusAnimationSequence()
    ...
    @SuppressWarnings("incomplete-switch")
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_MAS36_ANIMS =
            (stack, type) -> {
                int mag =
                        ((ItemGunBaseNT) stack.getItem())
                                .getConfig(stack, 0)
                    ...
                    case CYCLE:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .hold(350)
                                                .addPos(0, 0, pullAmount, 250, IType.SIN_UP)
                                                .hold(250)
                                ...
                                .addBus(
                                        "BULLET",
                                        mag <= 1
                                                ? new BusAnimationSequence().setPos(-100, 0, 0)
                                                : new BusAnimationSequence()
                                                        .hold(850)
                                                        .addPos(0, 0.1875, 1.5, 200, IType.LINEAR));
                    case CYCLE_DRY:
                        return new BusAnimation()
                                .addBus(
                                        "BOLT_TURN",
                    ...
                    case RELOAD:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .hold(100)
                                                .addPos(0, 0, -1.5D, 250, IType.SIN_UP)
                                                .holdUntil(1800)
                                                .addPos(0, 0, 0, 200, IType.LINEAR))
                                .addBus(
                                        "BULLET",
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .hold(200)
                                                .addPos(30, 0, 0, 500, IType.SIN_FULL)
                                                .holdUntil(1200)
                                                .addPos(0, 0, 0, 500, IType.SIN_FULL))
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .setPos(2, -3, 0)
                                                .hold(250)
                                                .addPos(0.5, 1, 0, 500, IType.SIN_DOWN)
                                                .addPos(0, 0, 0, 250, IType.SIN_FULL)
                                                .hold(400)
                                                .addPos(-0.5, 0.5, 0, 150)
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                ...
                                                .addPos(0, 0, 0, 250, IType.SIN_FULL)
                                                .hold(150)
                                                .addPos(0, -1.5, 0, 250, IType.SIN_DOWN));
                    case JAMMED:
                        return new BusAnimation()
                                .addBus(
                                        "LIFT",
                    ...
                    case INSPECT:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .hold(100)
                                                .addPos(0, 0, -1D, 250, IType.SIN_UP)
                                                .hold(500)
                                                .addPos(0, 0, 0, 200, IType.LINEAR))
                                .addBus(
                                        "BULLET",
                                        mag == 0
                                                ...
                                                : new BusAnimationSequence()
                                                        .setPos(0, 0.1875, 1.5)
                                                        .hold(100)
                                                        .addPos(0, 0.125, 0.5, 250, IType.SIN_UP)
                                                        .hold(500)
                                                        .addPos(0, 0.1875, 1.5, 200, IType.LINEAR));
                }
    ...
    public static void init(IRegistrar r) {
        SpentCasing casing762 =
                new SpentCasing(CasingType.BOTTLENECK).setColor(SpentCasing.COLOR_CASE_BRASS);
        r762_sp =
                new BulletConfig()
                        .setItem(EnumAmmo.R762_SP)
                        .setCasing(EnumCasingType.SMALL, 6)
                        .setCasing(casing762.clone().register("r762"));
        r762_fmj =
                new BulletConfig()
                        .setItem(EnumAmmo.R762_FMJ)
                        .setCasing(EnumCasingType.SMALL, 6)
                        .setDamage(0.8F)
        ...
        energy_lacunae =
                new BulletConfig()
                        ...
                        .setCasing(() -> new ItemStack(ModItems.ingot(Mats.MAT_POLYMER), 2), 4 * 40)
                                                ...
                                                new GunConfig()
                                                        ...
                                                        .rec(
                                                                new Receiver(0)
                                                                        ...
                                                                        .setupStandardFire()
                                                                        .recoil(
                                                                                LAMBDA_RECOIL_CARBINE))
                                                        .setupStandardConfiguration()
                                                        .anim(LAMBDA_CARBINE_ANIMS)
                                                        .orchestra(Orchestras.ORCHESTRA_CARBINE))
                                        .setDefaultAmmo(EnumAmmo.R762_SP, 14),
                        Item.Properties::new);
                                                ...
                                                new GunConfig()
                                                        ...
                                                        .rec(
                                                                new Receiver(0)
                                                                        ...
                                                                        .setupStandardFire()
                                                                        .recoil(
                                                                                LAMBDA_RECOIL_MINIGUN))
                                                        .setupStandardConfiguration()
                                                        .anim(LAMBDA_MINIGUN_ANIMS)
                                                        .orchestra(Orchestras.ORCHESTRA_MINIGUN))
                                        .setDefaultAmmo(EnumAmmo.R762_FMJ, 30),
                        Item.Properties::new);
                        ...
                        props ->
                                new ItemGunBaseNT(
                                                ...
                                                new GunConfig()
                                                        ...
                                                        .anim(LAMBDA_MINIGUN_ANIMS)
                                                        .orchestra(
                                                                Orchestras.ORCHESTRA_MINIGUN_DUAL),
                                                new GunConfig()
                                                        .dura(50_000)
                                                        .draw(20)
                                                        .inspect(20)
                                                        ...
                                                        .orchestra(
                                                                Orchestras.ORCHESTRA_MINIGUN_DUAL))
                                        .setDefaultAmmo(EnumAmmo.R762_SP, 50),
                        Item.Properties::new);
                                                        ...
                                                        .rec(
                                                                new Receiver(0)
                                                                        ...
                                                                        .recoil(
                                                                                LAMBDA_RECOIL_CARBINE))
                                                        .setupStandardConfiguration()
                                                        .anim(LAMBDA_MAS36_ANIMS)
                                                        .orchestra(Orchestras.ORCHESTRA_MAS36))
                                        .setDefaultAmmo(EnumAmmo.R762_AP, 14),
                        Item.Properties::new);
    }
}
