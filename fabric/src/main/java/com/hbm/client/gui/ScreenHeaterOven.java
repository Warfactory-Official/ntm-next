...
public class ScreenHeaterOven extends ScreenInfoContainer<MenuHeaterOven> {

    private static final Identifier TEXTURE =
            Library.id("textures/gui/machine/gui_heating_oven.png");

    public ScreenHeaterOven(MenuHeaterOven menu, Inventory inventory, Component title) {
    ...
    private BlockEntityHeaterOven oven() {
