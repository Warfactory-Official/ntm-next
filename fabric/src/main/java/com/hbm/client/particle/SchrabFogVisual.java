...
public final class SchrabFogVisual
        implements EffectVisual<ParticleSchrabFog.SchrabFogParticle>,
                SimpleTickableVisual,
                ShaderLightVisual {
    private final ParticleSchrabFog.SchrabFogParticle particle;
    ...
    public SchrabFogVisual(
            VisualizationContext context, ParticleSchrabFog.SchrabFogParticle particle) {
