...
public final class GasFlameVisual implements EffectVisual<ParticleGasFlame>, SimpleTickableVisual {
    private final ParticleGasFlame particle;
    private final ParticleInstance instance;
    private final Vec3i origin;

    public GasFlameVisual(VisualizationContext context, ParticleGasFlame particle) {
        this.particle = particle;
        this.origin = context.renderOrigin();
        this.instance =
                context.instancerProvider()
                        .instancer(ParticleInstance.GROW_IN, ParticleModels.UNLIT)
                        .createInstance();
        writeTick();
    }
