...
public final class VolcanoSmokeVisual
        implements EffectVisual<ParticleVolcanoSmoke>, SimpleTickableVisual, ShaderLightVisual {
    private final ParticleVolcanoSmoke particle;
    ...
    public VolcanoSmokeVisual(VisualizationContext context, ParticleVolcanoSmoke particle) {
