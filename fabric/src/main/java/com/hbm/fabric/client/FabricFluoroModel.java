...
public final class FabricFluoroModel extends FluoroModel {

    public FabricFluoroModel(ModelBaker baker, ResolvedModel base, Direction facing) {
        super(baker, base, facing);
    }
