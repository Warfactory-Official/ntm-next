...
public class XFactory22lr {
    ...
    public static Function<ItemStack, String> LAMBDA_NAME_SILENCED =
            (stack) -> {
                if (XWeaponModManager.hasUpgrade(stack, 0, XWeaponModManager.ID_SILENCER))
                    return stack.getItem().getDescriptionId() + "_silenced";
                return null;
            };
    ...
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_RECOIL_AM180 =
            (stack, ctx) -> {
                ItemGunBaseNT.setupRecoil(
                        (float) (ctx.getPlayer().getRandom().nextGaussian() * 0.25),
                        (float) (ctx.getPlayer().getRandom().nextGaussian() * 0.25));
            };
    public static BiConsumer<ItemStack, LambdaContext> LAMBDA_RECOIL_STAR_F =
            (stack, ctx) -> {
                ItemGunBaseNT.setupRecoil(
                        2.5F, (float) (ctx.getPlayer().getRandom().nextGaussian() * 0.5));
            };

    @SuppressWarnings("incomplete-switch")
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_AM180_ANIMS =
            (stack, type) -> {
                        ...
                        case CYCLE_DRY:
                            return new BusAnimation()
                                    ...
                                    .addBus(
                                            ...
                                            new BusAnimationSequence()
                                                    .addPos(0, 0, 0, 300)
                                                    .addPos(0, 0, 15, 250, IType.SIN_FULL)
                                                    .addPos(0, 0, 15, 400)
                            ...
                            return new BusAnimation()
                                    .addBus(
                                            ...
                                            new BusAnimationSequence()
                                                    ...
                                                    .addPos(15, 0, 0, 250)
                                                    .addPos(15, 0, 70, 300, IType.SIN_FULL)
                                                    .addPos(15, 0, 0, 0)
                                                    .addPos(15, 0, 0, 750)
                                                    .addPos(0, 0, 0, 250, IType.SIN_FULL))
                                    .addBus(
                                            ...
                                            new BusAnimationSequence()
                                                    .addPos(0, 0, 0, 250)
                                                    .addPos(2, 0, -4, 250, IType.SIN_FULL)
                                                    .addPos(-10, 2, -4, 300, IType.SIN_UP)
                                                    .addPos(3, -6, -4, 0)
                                                    .addPos(2, 0, -4, 500, IType.SIN_FULL)
                                                    .addPos(0, 0, 0, 250, IType.SIN_FULL))
                                    .addBus(
                                            "BOLT",
                                            new BusAnimationSequence()
                        ...
                        case INSPECT:
                            return new BusAnimation()
                                    ...
                                    .addBus(
                                            ...
                                            new BusAnimationSequence()
                                                    .addPos(0, 0, 0, 200)
                                                    .addPos(4, -1, -4, 200, IType.SIN_FULL)
                                                    .addPos(4, -1.5, -4, 50)
                                                    .addPos(4, 0, -4, 100)
                                                    .addPos(4, 6, -4, 250, IType.SIN_DOWN)
                                                    .addPos(4, 0, -4, 150, IType.SIN_UP)
                                                    .addPos(4, -1, -4, 100, IType.SIN_DOWN)
                                                    .addPos(4, -1, -4, 250)
                                                    .addPos(0, 0, 0, 250, IType.SIN_FULL))
                                    .addBus(
                                            "MAGSPIN",
                                            new BusAnimationSequence()
                                                    .addPos(0, 0, 0, 600)
                                                    .addPos(-400, 0, 0, 500, IType.SIN_FULL)
                                                    .addPos(-400, 0, 0, 250)
                                                    .addPos(-360, 0, 0, 250));
                    }
                } else {
    ...
    @SuppressWarnings("incomplete-switch")
    public static BiFunction<ItemStack, GunAnimation, BusAnimation> LAMBDA_STAR_F_ANIMS =
            (stack, type) -> {
                int ammo =
                    ...
                    case CYCLE_DRY:
                        return new BusAnimation()
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 600)
                                                .addPos(-3, 0, 0, 175, IType.SIN_DOWN)
                    ...
                    case RELOAD:
                        return new BusAnimation()
                                .addBus(
                                        "TILT",
                                        new BusAnimationSequence()
                                                .addPos(-30, 0, 0, 250, IType.SIN_FULL)
                                                .hold(1500)
                                                .addPos(0, 0, 0, 250, IType.SIN_FULL))
                                .addBus(
                                        "SLIDE",
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 250)
                                                .addPos(0, 0, -1, 100, IType.SIN_FULL)
                                                .hold(1125)
                                                .addPos(0, 0, 0, 100, IType.SIN_UP))
                                .addBus(
                                        "MAG",
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 250)
                                                .addPos(0, -7, -1.5, 300, IType.SIN_UP)
                                                .hold(400)
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(3, 0, 0, 750, IType.SIN_FULL)
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 200)
                                                .addPos(0, 0, 15, 300, IType.SIN_FULL)
                                                .hold(900)
                                                .addPos(0, 0, 0, 150, IType.SIN_FULL))
                                .addBus(
                                        "BULLET",
                                        new BusAnimationSequence()
                                                .setPos(ammo <= 1 ? 100 : 0, 0, 0)
                                                .hold(750)
                                                .setPos(0, 0, 0)
                                                .hold(750)
                                                .addPos(0, 0.5, 2.25, 50));
                    case JAMMED:
                        return new BusAnimation()
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(-30, 0, 0, 150, IType.SIN_FULL)
                                                .hold(800)
                                                .addPos(0, 0, 0, 150, IType.SIN_FULL))
                                .addBus(
                                        "TURN",
                                        new BusAnimationSequence()
                                                .addPos(0, 0, 0, 500)
                                                .addPos(0, 0, 25, 150, IType.SIN_FULL)
                                                .hold(800)
                                                .addPos(0, 0, 0, 150, IType.SIN_FULL))
                                .addBus(
                                        "SLIDE",
                                ...
                                .addBus(
                                        ...
                                        new BusAnimationSequence()
                                                .setPos(0, 0.5, 2.25)
                                                .hold(750)
                                                .addPos(0, 0.5, 1.25, 100, IType.SIN_FULL)
                                                .hold(100)
                                                .addPos(0, 0.5, 2.25, 100, IType.SIN_UP)
                                                .hold(100)
                                                .addPos(0, 0.5, 1.25, 100, IType.SIN_FULL)
                                                .hold(100)
                                                .addPos(0, 0.5, 2.25, 100, IType.SIN_UP));
    ...
    public static void init(IRegistrar r) {
        ...
        p22_ap =
                new BulletConfig()
                        .setItem(EnumAmmo.P22_AP)
                        .setCasing(EnumCasingType.SMALL_STEEL, 24)
                        .setKnockback(0F)
                ...
                r.registerItem(
                        ...
                        props ->
                                new ItemGunBaseNT(
                                        ...
                                        .setDefaultAmmo(EnumAmmo.P22_SP, 35)
                                        .setNameMutator(LAMBDA_NAME_SILENCED),
                        Item.Properties::new);
                                                ...
                                                new GunConfig()
                                                        ...
                                                        .rec(
                                                                new Receiver(0)
                                                                        ...
                                                                        .setupStandardFire()
                                                                        .recoil(
                                                                                LAMBDA_RECOIL_STAR_F))
                                                        .setupStandardConfiguration()
                                                        .anim(LAMBDA_STAR_F_ANIMS)
                                                        .orchestra(Orchestras.ORCHESTRA_STAR_F))
                                        .setDefaultAmmo(EnumAmmo.P22_SP, 15)
                                        .setNameMutator(LAMBDA_NAME_SILENCED),
                        Item.Properties::new);
                        ...
                        props ->
                                new ItemGunBaseNT(
                                                ...
                                                new GunConfig()
                                                        ...
                                                        .anim(LAMBDA_STAR_F_ANIMS)
                                                        .orchestra(
                                                                Orchestras.ORCHESTRA_STAR_F_AKIMBO),
                                                new GunConfig()
                                                        .dura(15 * 25)
                                                        .draw(15)
                                                        .inspect(38)
                                                        ...
                                                        .orchestra(
                                                                Orchestras.ORCHESTRA_STAR_F_AKIMBO))
                                        .setDefaultAmmo(EnumAmmo.P22_SP, 30),
                        Item.Properties::new);
    }
}
