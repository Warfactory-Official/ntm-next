...
public class BlockEntityRBMKAbsorber extends BlockEntityRBMKBase implements SyncUnitSchema {

    public BlockEntityRBMKAbsorber(BlockPos pos, BlockState state) {
        super(ModBlockEntities.RBMK_ABSORBER.get(), pos, state, 0);
    }
