...
public class NukeGadget extends NukeAssemblyBase {

    public NukeGadget(Properties props) {
        super(props);
    }

    @Override
    public @Nullable BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new BlockEntityNukeGadget(pos, state);
    }
    ...
    protected void ignite(Level level, BlockPos pos, int yield, @Nullable Entity detonator) {
        ...
        EntityNukeTorex.statFac(level, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5, yield);
    }
}
