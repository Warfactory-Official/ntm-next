...
public class PneumoStorageClutterBlock extends PneumaticStorageBlockBase
    ...
    public PneumoStorageClutterBlock(Properties props) {
        super(props);
    }

    @Override
    public @Nullable BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new BlockEntityPneumoStorageClutter(pos, state);
    }

    @Override
    public MachineCaps caps() {
        return MachineCaps.of(ModBlockEntities.PNEUMATIC_STORAGE_CLUTTER).fluidIn();
    }
}
