...
public class MachineTurbine extends Block implements ITickingBlock, ICapabilityBlock {

    public MachineTurbine(Properties props) {
        super(props);
    }

    @Override
    public @Nullable BlockEntity newBlockEntity(BlockPos pos, BlockState state) {
        return new BlockEntityMachineTurbine(pos, state);
    }
    ...
    public MachineCaps caps() {
        return MachineCaps.of(ModBlockEntities.TURBINE)
                .powerOut()
                .fluidIn()
                .fluidOut()
                .items()
